...
using RemoteWalkContext = NuGet.DependencyResolver.RemoteWalkContext;

namespace NuGet.DependencyResolverV2.Tests
{
    public class RemoteDependencyWalkerTests
    {
        ...
        public async Task CyclesAreDetected()
        {
            ...
            AssertPath(cycle, node, "A 1.0", "B 2.0", "A 1.0");
        }
        ...
        public async Task CyclesAreDetectedIf2VersionsOfTheSamePackageId()
        {
            ...
            AssertPath(cycle, node, "A 1.0", "B 2.0", "A 5.0");
        }
        ...
        public async Task DeepCycleCheck()
        {
            ...
            AssertPath(cycle, node, "A 1.0", "B 2.0", "C 2.0", "E 1.0", "A 1.0");
        }
        ...
        public async Task SingleConflict()
        {
            ...
            AssertPath(c1, node, "A 1.0", "B 2.0", "D 2.0");
            AssertPath(c2, node, "A 1.0", "C 2.0", "D 1.0");
        }
        ...
        public async Task ConflictAtDifferentLevel()
        {
            ...
            AssertPath(c1, node, "A 1.0", "B 2.0", "D 2.0", "E 2.0");
            AssertPath(c2, node, "A 1.0", "F 2.0", "E 1.0");
        }
        ...
        public async Task TryResolveConflicts_ThrowsIfPackageConstraintCannotBeResolved()
        {
            ...
            AssertPath(c1, node, "Root 1.0", "B 2.0", "C 1.8");
            AssertPath(c2, node, "Root 1.0", "A 1.0", "C 1.3.8");
        }
        ...
        */
        ...
        public async Task NearestWinsOverridesStrictDependencyButDowngradeWarns()
        {
            ...
            AssertPath(downgraded, node, "A 1.0", "B 2.0", "D 2.0");
            AssertPath(downgradedBy, node, "A 1.0", "D 1.0");
        }
        ...
        public async Task DowngradeAtRootIsDetected()
        {
            ...
            AssertPath(downgraded, node, "A 1.0", "B 2.0", "C 2.0");
            AssertPath(downgradedBy, node, "A 1.0", "C 1.0");
        }
        ...
        public async Task DowngradeNotAtRootIsDetected()
        {
            ...
            AssertPath(downgraded, node, "A 1.0", "B 2.0", "C 2.0", "D 2.0");
            AssertPath(downgradedBy, node, "A 1.0", "B 2.0", "D 1.0");
        }
        ...
        public async Task DowngradeThenUpgradeThenDowngrade()
        {
            ...
            AssertPath(downgraded, node, "A 1.0", "C 1.0", "B 2.0");
            AssertPath(downgradedBy, node, "A 1.0", "B 1.0");
        }
        ...
        public async Task DoubleDowngrade()
        {
            ...
            AssertPath(d0To, node, "A 1.0", "C 1.0", "B 0.8");
            AssertPath(d0By, node, "A 1.0", "B 0.7");

            var d1 = result.Downgrades[1];
            var d1To = d1.DowngradedFrom;
            var d1By = d1.DowngradedTo;

            AssertPath(d1To, node, "A 1.0", "C 1.0", "D 1.0", "B 1.0");
            AssertPath(d1By, node, "A 1.0", "B 0.7");
        ...
        */
        ...
        public async Task WalkAsyncAddsTransitiveCentralDependency(string centralPackageVersion, string otherVersion)
        {
            ...
            // Act
            var rootNode = await DoWalkAsync(context, "A", framework);
        ...
        */
            ...
            LibraryIncludeFlags? privateAssets2, int expectedConflicts)
        {
            ...
            {
                AssertPath(result.VersionConflicts[0].Conflicting, rootNode, "A 1.0.0", "B 1.0.0", "D 1.0.0");
                AssertPath(result.VersionConflicts[0].Selected, rootNode, "A 1.0.0", "C 1.0.0", "D 2.0.0");
            }
        }
        ...
        public async Task PrivateAssetsAll_VersionDowngrades(LibraryIncludeFlags? privateAssets1, LibraryIncludeFlags? privateAssets2, int expectedDowngrades)
        {
            ...
            if (expectedDowngrades == 1)
            {
                ...
                AssertPath(downgraded, rootNode, "A 1.0.0", "B 1.0.0", "C 2.0.0");
                AssertPath(downgradedBy, rootNode, "A 1.0.0", "C 1.0.0");
            }
        }
        ...
        private void AssertPath(List<LibraryDependency> path, WalkResult walkResult, params string[] items)
        {
            var matches = new List<string>();

            foreach (var dependency in path)
            {
                matches.Insert(0, $"{dependency.LibraryRange.Name} {walkResult[dependency.LibraryRange]?.Key?.Version ?? dependency.LibraryRange.VersionRange.MinVersion}");
            }

            Assert.Equal(items, matches);
        }

        private Task<WalkResult> DoWalkAsync(RemoteDependencyWalker walker, string name)
        {
            return DoWalkAsync(walker, name, NuGetFramework.Parse("net45"));
        }

        private Task<WalkResult> DoWalkAsync(RemoteDependencyWalker walker, string name, NuGetFramework framework)
        {
