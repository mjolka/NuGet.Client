...
namespace NuGet.ProjectModel.Test
{
    public class PackageSpecReferenceDependencyProviderTests
    {
        ...
        public void GetSpecDependencies_AddsCentralPackageVersionsIfDefined(bool cpvmEnabled, bool tdpDisabled)
        {
            // Arrange
            ...
            var dependencyGraphSpec = CreateDependencyGraphSpecWithCentralDependencies(cpvmEnabled, tdpDisabled, tfi);
        ...
        private static DependencyGraphSpec CreateDependencyGraphSpecWithCentralDependencies(bool cpvmEnabled, bool tdpDisabled, params TargetFrameworkInformation[] tfis)
        {
            ...
            packageSpec.RestoreMetadata = new ProjectRestoreMetadata
            {
                ...
                TransitiveDependencyPinningDisabled = tdpDisabled,
            };
